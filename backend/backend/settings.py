...
SECRET_KEY = os.getenv("DJANGO_SECRET_KEY", "django-insecure-prod-ready-development-key-1234567890")
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": os.getenv("POSTGRES_DB", "aifinance"),
            "USER": os.getenv("POSTGRES_USER", "aifinance"),
            "PASSWORD": os.getenv("POSTGRES_PASSWORD", "aifinance_password"),
